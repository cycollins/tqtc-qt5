...
def init(args):
    ...
    cmd = "perl init-repository%s --module-subset \"essential,qtandroidextras,qtgraphicaleffects,qtimageformats,qtlocation,qtmacextras,qtquickcontrols,qtquickcontrols2,qtsensors,qtsvg,qtvirtualkeyboard,qtwebview,qtwinextras,qtxmlpatterns\" -f%s --mirror=%s" % (no_checkout_arg, user_arg, args.mirror)
